  ...
  })()(
    {
        ...
        function (e, t, r) {
          ...
          (r.byteLength = function (e) {
            ...
            (r.fromByteArray = function (e) {
              for (
                var t, r = e.length, i = r % 3, a = [], s = 0, o = r - i;
                s < o;
                s += 16383
              )
      ...
      5: [
        function (e, t, r) {
          (function (t) {
            ...
            function h(e) {
              return f(e), o(e < 0 ? 0 : 0 | d(e));
            }
            function u(e) {
              for (
                var t = e.length < 0 ? 0 : 0 | d(e.length), r = o(t), n = 0;
                n < t;
                n += 1
              )
                r[n] = 255 & e[n];
            ...
            function b(e, r, n, i, a) {
              ...
              if (('string' == typeof r && (r = t.from(r, i)), t.isBuffer(r)))
                return 0 === r.length ? -1 : g(e, r, n, i, a);
              if ('number' == typeof r)
                return (
                  (r &= 255),
            ...
            (r.kMaxLength = s),
              ...
              (t.compare = function (e, r) {
                ...
                if (e === r) return 0;
                for (
                  var n = e.length, i = r.length, a = 0, s = Math.min(n, i);
                  a < s;
                  ++a
                )
                  if (e[a] !== r[a]) {
              ...
              (t.prototype.compare = function (e, r, n, i, a) {
                if (
                  (z(e, Uint8Array) && (e = t.from(e, e.offset, e.byteLength)),
                  !t.isBuffer(e))
                )
            ...
            (t.prototype.slice = function (e, r) {
              ...
              (t.prototype.copy = function (e, r, n, i) {
                ...
                if (
                  ...
                  for (var s = a - 1; s >= 0; --s) e[s + r] = this[s + n];
              ...
              (t.prototype.fill = function (e, r, n, i) {
                ...
                if (
                  ...
                  var o = t.isBuffer(e) ? e : t.from(e, i),
                    c = o.length;
                  if (0 === c)
                    throw new TypeError(
                      'The value "' + e + '" is invalid for argument "value"'
                    );
                  for (s = 0; s < n - r; ++s) this[s + r] = o[s % c];
                }
                return this;
              });
            var N = /[^+/0-9A-Za-z-_]/g;
            ...
            function R(e) {
              return n.toByteArray(
                (function (e) {
                  if (
                    (e = (e = e.split('=')[0]).trim().replace(N, '')).length < 2
                  )
                    return '';
                  for (; e.length % 4 != 0; ) e += '=';
                  return e;
        ...
        { 'base64-js': 1, buffer: 5, ieee754: 29 },
      ],
      6: [
        function (e, t, r) {
          t.exports = new (class {
            ...
            floydsteinberg(e) {
              ...
              for (let t = 0, n = 0; n < e.data.length; t++, n += 4)
                r[t] =
                  0.299 * e.data[n] +
                  0.587 * e.data[n + 1] +
                  0.114 * e.data[n + 2];
          ...
          t.exports = new (class {
            flatten(e, t) {
              for (let r = 0; r < e.data.length; r += 4) {
                let n = e.data[r + 3],
                  i = 255 - n;
                (e.data[r] = (n * e.data[r] + i * t[0]) / 255),
                  (e.data[r + 1] = (n * e.data[r + 1] + i * t[1]) / 255),
                  (e.data[r + 2] = (n * e.data[r + 2] + i * t[2]) / 255),
                  (e.data[r + 3] = 255);
              }
              return e;
            }
        ...
        function (e, t, r) {
          ...
          t.exports = function (e) {
            ...
            let n,
              ...
              u,
              d,
              l = e.substring(0, t.index);
            switch (
              ((n = i.exec(l)) && (r.weight = n[1]),
              (h = a.exec(l)) && (r.style = h[1]),
              (u = s.exec(l)) && (r.variant = u[1]),
              (d = o.exec(l)) && (r.stretch = d[1]),
              r.unit)
            ) {
              case 'pt':
                r.size /= 0.75;
      ...
      10: [
        function (e, t, r) {
          ...
          r._dbcs = f;
          for (
            var i = -1, a = -2, s = -1e3, o = new Array(256), c = 0;
            c < 256;
            c++
          )
            o[c] = i;
          function f(e, t) {
            ...
            if (e.encodeSkipVals)
              for (n = 0; n < e.encodeSkipVals.length; n++) {
                var f = e.encodeSkipVals[n];
                if ('number' == typeof f) c[f] = !0;
                else for (var h = f.from; h <= f.to; h++) c[h] = !0;
              }
            ...
            if (
              ...
              var d = this.decodeTables.length,
                l = (this.decodeTables[d] = o.slice(0)),
                p = this.decodeTables.length,
                b = (this.decodeTables[p] = o.slice(0));
              for (n = 129; n <= 254; n++) {
                var g = s - this.decodeTables[0][n],
                  y = this.decodeTables[g];
                for (h = 48; h <= 57; h++) y[h] = s - d;
              }
              for (n = 129; n <= 254; n++) l[n] = s - p;
              for (n = 48; n <= 57; n++) b[n] = a;
            }
          }
          function h(e, t) {
          ...
          (f.prototype.encoder = h),
            (f.prototype.decoder = u),
            (f.prototype._getDecodeTrieNode = function (e) {
              ...
              for (var r = this.decodeTables[0], n = t.length - 1; n > 0; n--) {
                var a = r[t[n]];
                if (a == i)
                  (r[t[n]] = s - this.decodeTables.length),
            ...
            (f.prototype._setEncodeSequence = function (e, t) {
              var r,
                ...
                s = 255 & n;
              a[s] <= -10
                ? (r = this.encodeTableSeq[-10 - a[s]])
                : ((r = {}),
                  a[s] !== i && (r[-1] = a[s]),
                  (a[s] = -10 - this.encodeTableSeq.length),
                  this.encodeTableSeq.push(r));
              for (var o = 1; o < e.length - 1; o++) {
                var c = r[n];
                'object' == typeof c
                  ? (r = c)
                  : ((r = r[n] = {}), void 0 !== c && (r[-1] = c));
              }
              r[(n = e[e.length - 1])] = t;
            }),
              ...
              for (var n = this.decodeTables[e], i = 0; i < 256; i++) {
                ...
                r[o] ||
                  (a >= 0
                    ...
                    : a <= s
                    ? this._fillEncodeTable(s - a, o << 8, r)
                    : a <= -10 &&
              ...
              for (
                ...
                if (void 0 !== a && f != i) {
                  ...
                  if (h == i && this.gb18030) {
                    ...
                    if (-1 != p) {
                      h =
                        this.gb18030.gbChars[p] + (f - this.gb18030.uChars[p]);
                      (t[c++] = 129 + Math.floor(h / 12600)),
                        (h %= 12600),
                        (t[c++] = 48 + Math.floor(h / 1260)),
                        (h %= 1260),
                        (t[c++] = 129 + Math.floor(h / 10)),
                        (h %= 10),
                        (t[c++] = 48 + h);
                      continue;
                    }
                ...
                h === i && (h = this.defaultCharSingleByte),
                  h < 256
                    ? (t[c++] = h)
                    : h < 65536
                    ? ((t[c++] = h >> 8), (t[c++] = 255 & h))
            ...
            (u.prototype.write = function (e) {
              ...
              c > 0 && (o = n.concat([o, e.slice(0, 10)]));
              for (var h = 0, u = 0; h < e.length; h++) {
                var l,
                  p = h >= 0 ? e[h] : o[h + c];
                if ((l = this.decodeTables[r][p]) >= 0);
                else if (l === i)
                  (h = f), (l = this.defaultCharUnicode.charCodeAt(0));
                else if (l === a) {
                  var b =
                      f >= 0 ? e.slice(f, h + 1) : o.slice(f + c, h + 1 + c),
                    g =
                      12600 * (b[0] - 129) +
                      1260 * (b[1] - 48) +
                      10 * (b[2] - 129) +
                      (b[3] - 48),
                    y = d(this.gb18030.gbChars, g);
                  ...
                  for (
                    var w = this.decodeTableSeq[-10 - l], m = 0;
                    m < w.length - 1;
                    m++
                  )
                    (l = w[m]), (t[u++] = 255 & l), (t[u++] = l >> 8);
                  l = w[w.length - 1];
                }
                if (l > 65535) {
                  l -= 65536;
                  var v = 55296 + Math.floor(l / 1024);
                  (t[u++] = 255 & v),
                    (t[u++] = v >> 8),
                    (l = 56320 + (l % 1024));
                }
              ...
              return (
                (this.nodeIdx = r),
                (this.prevBuf = f >= 0 ? e.slice(f) : o.slice(f + c)),
      ...
      11: [
        ...
        {
          './tables/big5-added.json': 17,
          './tables/cp936.json': 18,
          './tables/cp949.json': 19,
          './tables/cp950.json': 20,
          './tables/eucjp.json': 21,
          './tables/gb18030-ranges.json': 22,
          './tables/gbk-added.json': 23,
          './tables/shiftjis.json': 24,
        },
      ],
      12: [
        function (e, t, r) {
      ...
      13: [
        ...
        { 'safer-buffer': 32, string_decoder: 4 },
      ],
      14: [
        function (e, t, r) {
          'use strict';
          ...
          (r._sbcs = i),
            ...
            (s.prototype.write = function (e) {
              for (
                ...
                (i = 2 * e[s]), (r[(a = 2 * s)] = t[i]), (r[a + 1] = t[i + 1]);
      ...
      25: [
        function (e, t, r) {
          ...
          (r.utf16be = i),
            ...
            (s.prototype.end = function () {}),
            (r.utf16 = o),
            (o.prototype.encoder = c),
            (o.prototype.decoder = f),
            (c.prototype.write = function (e) {
            ...
            (f.prototype.end = function () {
              if (!this.decoder) {
                var e = n.concat(this.initialBytes),
                  t = h(e, this.options.defaultEncoding);
                this.decoder = this.iconv.getDecoder(t, this.options);
      ...
      26: [
        function (e, t, r) {
          ...
          (s.prototype.write = function (e) {
            ...
            (s.prototype.end = function () {});
          for (var c = /[A-Za-z0-9\/+]/, f = [], h = 0; h < 256; h++)
            f[h] = c.test(String.fromCharCode(h));
          var u = '+'.charCodeAt(0),
            d = '-'.charCodeAt(0),
            l = '&'.charCodeAt(0);
          function p(e, t) {
          ...
          (o.prototype.write = function (e) {
            for (
              var t = '', r = 0, i = this.inBase64, a = this.base64Accum, s = 0;
              s < e.length;
              s++
            )
              if (i) {
                ...
                e[s] == u &&
                  ...
                  (i = !0));
            if (i) {
              var c = (o = a + e.slice(r).toString()).length - (o.length % 8);
              (a = o.slice(c)),
                (o = o.slice(0, c)),
                (t += this.iconv.decode(n.from(o, 'base64'), 'utf16-be'));
            ...
            (b.prototype.write = function (e) {
              ...
              return (
                (this.inBase64 = t), (this.base64AccumIdx = i), a.slice(0, s)
              );
            }),
          ...
          (y[','.charCodeAt(0)] = !0),
            (g.prototype.write = function (e) {
                ...
                if (i) {
                  if (!y[e[s]]) {
                    if (s == r && e[s] == d) t += '&';
                      ...
                      var o = a + e.slice(r, s).toString().replace(/,/g, '/');
                      t += this.iconv.decode(n.from(o, 'base64'), 'utf16-be');
                    }
                    e[s] != d && s--, (r = s + 1), (i = !1), (a = '');
                  }
              ...
              if (i) {
                var c =
                  (o = a + e.slice(r).toString().replace(/,/g, '/')).length -
                  (o.length % 8);
                (a = o.slice(c)),
                  (o = o.slice(0, c)),
                  (t += this.iconv.decode(n.from(o, 'base64'), 'utf16-be'));
        ...
        function (e, t, r) {
          (function (r) {
            ...
            (a.encodings = null),
              ...
              (a.encode = function (e, t, r) {
                e = '' + (e || '');
                var i = a.getEncoder(t, r),
                  s = i.write(e),
                  o = i.end();
                return o && o.length > 0 ? n.concat([s, o]) : s;
              }),
              (a.decode = function (e, t, r) {
                'string' == typeof e &&
                  (a.skipDecodeWarning ||
                    ...
                    (a.skipDecodeWarning = !0)),
                  (e = n.from('' + (e || ''), 'binary')));
                var i = a.getDecoder(t, r),
                  s = i.write(e),
                  o = i.end();
                return o ? s + o : s;
              }),
              ...
              (a._codecDataCache = {}),
              (a.getCodec = function (t) {
                a.encodings || (a.encodings = e('../encodings'));
                for (var r = a._canonicalizeEncoding(t), n = {}; ; ) {
                  var i = a._codecDataCache[r];
                  if (i) return i;
                  var s = a.encodings[r];
                  switch (typeof s) {
                    case 'string':
                    ...
                    case 'function':
                      return (
                        ...
                        (i = new s(n, a)),
                        (a._codecDataCache[n.encodingName] = i),
                        i
                      );
                    default:
                      throw new Error(
              ...
              (a.getEncoder = function (e, t) {
                var r = a.getCodec(e),
                  n = new r.encoder(t, r);
                return (
                  r.bomAware && t && t.addBOM && (n = new i.PrependBOM(n, t)), n
                );
              }),
              (a.getDecoder = function (e, t) {
                ...
                return (
                  !r.bomAware ||
                    (t && !1 === t.stripBOM) ||
                    (n = new i.StripBOM(n, t)),
                  n
                );
              });
            var s = void 0 !== r && r.versions && r.versions.node;
            if (s) {
              var o = s.split('.').map(Number);
              (o[0] > 0 || o[1] >= 10) && e('./streams')(a),
                e('./extend-node')(a);
            }
                ...
                t = Math.abs(t),
                  isNaN(t) || t === 1 / 0
                    ...
                    : ((s = Math.floor(Math.log(t) / Math.LN2)),
                      ...
                      (t += s + u >= 1 ? d / c : d * Math.pow(2, 1 - u)) * c >=
                        2 && (s++, (c /= 2)),
                      s + u >= h
                        ? ((o = 0), (s = h))
                        : s + u >= 1
                        ? ((o = (t * c - 1) * Math.pow(2, i)), (s += u))
                        : ((o = t * Math.pow(2, u - 1) * Math.pow(2, i)),
                          (s = 0)));
                i >= 8;
                e[r + l] = 255 & o, l += p, o /= 256, i -= 8
              );
              for (
                s = (s << i) | o, f += i;
                f > 0;
                e[r + l] = 255 & s, l += p, s /= 256, f -= 8
              );
              e[r + l - p] |= 128 * b;
            });
        },
      ...
      30: [
        function (e, t, r) {
          var n = {
            ...
            o = { soft: 1, hard: 1 },
            c = { collapse: 1, default: 1, line: 1, all: 1 },
            f = { all: 1, multi: 1, none: 1 },
            h = /([sm])(\d+)/,
            u = /[-/\\^$*+?.()|[\]{}]/g;
          function d(e) {
            return e.replace(u, '\\$&');
          ...
          var l = (t.exports = function (e, t, r) {
            'object' == typeof e && ((e = (r = e).start), (t = r.stop)),
              'object' == typeof t &&
                ((r = t), (e = e || r.start), (t = void 0)),
              t || ((t = e), (e = 0)),
              r || (r = {});
            var i,
              u,
            ...
            if ((i = r.preset))
              for (i instanceof Array || (i = [i]), T = 0; T < i.length; T++) {
                ...
                x.mode && (C = x.mode),
                  x.whitespace && (j = x.whitespace),
                  void 0 !== x.tabWidth && (I = x.tabWidth),
                  x.skip && (u = x.skip),
                  x.skipScheme && (l = x.skipScheme),
                  x.lineBreak && (p = x.lineBreak),
                  x.lineBreakScheme && (b = x.lineBreakScheme),
                  x.respectLineBreaks && (L = x.respectLineBreaks),
                  void 0 !== x.preservedLineIndent &&
                    (y = x.preservedLineIndent),
                  void 0 !== x.wrapLineIndent && (w = x.wrapLineIndent),
                  x.wrapLineIndentBase && (m = x.wrapLineIndentBase);
              }
            if (r.mode) {
              if (!o[r.mode])
                throw new TypeError(
                  'mode must be one of "' + Object.keys(o).join('", "') + '"'
                );
              C = r.mode;
            }
            if (r.whitespace) {
            ...
            if (void 0 !== r.tabWidth) {
              if (!(parseInt(r.tabWidth, 10) >= 0))
                throw new TypeError('tabWidth must be a non-negative integer');
              I = parseInt(r.tabWidth, 10);
            }
            if (((A = new Array(I + 1).join(' ')), r.respectLineBreaks)) {
              if (!f[r.respectLineBreaks] && !h.test(r.respectLineBreaks))
                throw new TypeError(
            ...
            if (void 0 !== r.preservedLineIndent) {
              if (!(parseInt(r.preservedLineIndent, 10) >= 0))
                throw new TypeError(
                  'preservedLineIndent must be a non-negative integer'
                );
              y = parseInt(r.preservedLineIndent, 10);
            }
            if (
              (y > 0 && (U = new Array(y + 1).join(' ')),
              void 0 !== r.wrapLineIndent)
            ) {
              if (isNaN(parseInt(r.wrapLineIndent, 10)))
            ...
            } else if (w > 0) O = new Array(w + 1).join(' ');
            else if (w < 0)
              throw new TypeError(
            ...
            if ((r.skip && (u = r.skip), u))
              if (u instanceof RegExp)
                (v = u).global ||
                  ...
                  v.ignoreCase && (S += 'i'),
                  v.multiline && (S += 'm'),
                  (v = new RegExp(v.source, S)));
              else {
                if ('string' != typeof u)
                  throw new TypeError(
                    'skip must be either a RegExp object or a string'
                  );
                v = new RegExp(d(u), 'g');
              }
            if ((!v && l && (v = s[l]), r.lineBreakScheme)) {
              if (!a[r.lineBreakScheme])
                throw new TypeError(
              ...
              if (
                (p instanceof Array &&
                  (1 === p.length
                    ? (p = p[0])
                    : p.length >= 2 &&
                      (p[0] instanceof RegExp
                        ? ((B = p[0]), 'string' == typeof p[1] && (E = p[1]))
                        : p[1] instanceof RegExp
                        ? ((B = p[1]), 'string' == typeof p[0] && (E = p[0]))
                        : 'string' == typeof p[0] && 'string' == typeof p[1]
                        ? ((B = new RegExp(d(p[0]), 'g')), (E = p[1]))
                        : (p = p[0]))),
                'string' == typeof p)
              )
                (E = p), B || (B = new RegExp(d(p), 'g'));
              else if (p instanceof RegExp) B = p;
            ...
            B || ((B = /\n/g), (E = '\n')),
              ...
              B.multiline && (S += 'm'),
              (_ = new RegExp(
                '\\s*(?:' + B.source + ')(?:' + B.source + '|\\s)*',
                S
              )),
              B.global || (B = new RegExp(B.source, S));
            var M = 'hard' === C ? /\b/ : /(\S+\s+)/,
              R = new Array(e + 1).join(' '),
              q = 'default' === j || 'collapse' === j,
              z = 'collapse' === j,
              D = 'line' === j,
              P = 'all' === j,
              W = /\t/g,
            ...
            return function (r) {
              var n;
              if (((r = r.toString().replace(W, A)), !E)) {
                if (((B.lastIndex = 0), !(n = B.exec(r))))
                  throw new TypeError(
                    'Line break string for the output not specified'
                  );
                E = n[0];
              }
              var i,
                ...
                d,
                l = 0;
              for (i = [], _.lastIndex = 0, n = _.exec(r); n; ) {
                if ((i.push(r.substring(l, n.index)), 'none' !== L)) {
                  for (s = [], o = 0, B.lastIndex = 0, a = B.exec(n[0]); a; )
                    s.push(n[0].substring(o, a.index)),
                      (o = a.index + a[0].length),
                      (a = B.exec(n[0]));
                  s.push(n[0].substring(o)),
                    i.push({ type: 'break', breaks: s });
                } else
                  (c = z ? ' ' : n[0].replace(B, '')),
                    i.push({ type: 'break', remaining: c });
                (l = n.index + n[0].length), (n = _.exec(r));
              }
              if ((i.push(r.substring(l)), v))
                for (d = [], f = 0; f < i.length; f++) {
                  ...
                  if ('string' != typeof p) d.push(p);
                    ...
                    for (l = 0, v.lastIndex = 0, n = v.exec(p); n; )
                      d.push(p.substring(l, n.index)),
                        d.push({ type: 'skip', value: n[0] }),
              ...
              for (f = 0; f < d.length; f++) {
                ...
                if ('string' != typeof y) b.push(y);
                  ...
                  for (h = 0; h < m.length; h++) {
                    var S = m[h];
                    if ('hard' === C)
                      for (u = 0; u < S.length; u += G)
                        x.push(S.slice(u, u + G));
                    else x.push(S);
                  }
                  b = b.concat(x);
                }
              ...
              function Q(r) {
                ...
                if (P)
                  ...
                  for (; n >= e && X.test(s[n]); ) n--;
                  ++n !== s.length && (N[j] = s.substring(0, n)),
                    J &&
                      Z &&
                      D &&
                      I > t &&
                ...
                if (
                  (J &&
                    ((J = !1),
                    k &&
                      ((n = N[j].substring(e).search(k)),
                      (K =
                        n >= 0 && n + w > 0
                          ? new Array(n + w + 1).join(' ')
                          : ''))),
                  a)
                ) {
                  for (; a + G < s.length; )
                    P
                      ? ((i = s.substring(a, a + G)), N.push(R + K + i))
                      : N.push(R + K),
                      (a += G),
                      j++;
                  if (!r) return (i = s.substring(a)), K + i;
                  P ? ((i = s.substring(a)), N.push(R + K + i)) : N.push(R + K),
                    j++;
                }
                return '';
              }
              for (f = 0; f < b.length; f++) {
                ...
                if ('' !== ee)
                  if ('string' == typeof ee) {
                    for (var te; ; ) {
                      if (
                        ...
                        if (
                          ...
                          (N[j] += T), (I += T.length), (Z = !0);
                          continue;
                        }
                        (!q && (!D || (J && Z))) || (ee = ee.replace(V, '')),
                          (Z = !1);
                      } else
                        Z &&
                          (q || (D && (!J || !Z))
                    ...
                    P && te && I + te.length > t && (H = I + te.length),
                      (N[j] += ee),
                      (I += ee.length);
                    ...
                    if ('none' !== L) {
                      ...
                      if ('s' === L) {
                        for (h = 0; h < ne; h++)
                          re[h + 1].length < g
                            ? (re[h + 1] = z ? ' ' : re[h] + re[h + 1])
                            : (P && ((N[j] += re[h]), (I += re[h].length)),
                              Q(!0),
                              N.push(R + U),
                              j++,
                              (I = e + U.length),
                        ...
                        for (Q(!0), h = 0; h < ne; h++) N.push(R + U), j++;
                        (I = e + U.length), (J = Z = !0);
                      } else
                        for (
                          (P || (J && Z)) &&
                            ((N[j] += re[0]), (I += re[0].length)),
                            h = 0;
                          h < ne;
                          h++
                        )
      ...
      32: [
        ...
        { _process: 31, buffer: 5 },
      ],
      33: [
        function (e, t, r) {
          const n = e('iconv-lite'),
            i = e('linewrap'),
            { createCanvas: a } = e('canvas'),
            s = e('canvas-dither'),
            o = e('canvas-flatten');
          t.exports = class {
            constructor() {
            ...
            codepage(e) {
              ...
              if (
                void 0 ===
                t[(r = 'string' == typeof n.encodings[e] ? n.encodings[e] : e)]
              )
                throw new Error('Codepage not supported by printer');
              return (
                (this._codepage = r),
                (this._state.hanzi = t[r][1]),
                this._queue([27, 116, t[r][0]]),
                this
              );
            }
            text(e, t) {
              t && (e = i(t, { lineBreak: '\r\n' })(e));
              let r = this._encode(e);
              return (
                this._state.hanzi
                  ? this._queue([28, 38, r, 28, 46])
                  : this._queue([r]),
                this
              );
            }
            ...
            underline(e) {
              return (
                void 0 === e && (e = !this._state.underline),
                (this._state.underline = e),
                this._queue([27, 45, Number(e)]),
                this
              );
            }
            italic(e) {
              return (
                void 0 === e && (e = !this._state.italic),
                (this._state.italic = e),
                this._queue([27, 52, Number(e)]),
                this
              );
            }
            bold(e) {
              return (
                void 0 === e && (e = !this._state.bold),
                (this._state.bold = e),
                this._queue([27, 69, Number(e)]),
                this
              );
            }
            size(e) {
              return (
                (e = 'small' === e ? 1 : 0), this._queue([27, 77, e]), this
              );
            }
            align(e) {
              const t = { left: 0, center: 1, right: 2 };
              if (!(e in t)) throw new Error('Unknown alignment');
              return this._queue([27, 97, t[e]]), this;
            }
            barcode(e, t, r) {
              const i = {
                upca: 0,
            ...
            qrcode(e, t, r, i) {
              this._queue([10]);
              const a = { 1: 49, 2: 50 };
              if ((void 0 === t && (t = 2), !(t in a)))
                throw new Error('Model must be 1 or 2');
              if (
                (this._queue([29, 40, 107, 4, 0, 49, 65, a[t], 0]),
                void 0 === r && (r = 6),
                'number' != typeof r)
              )
              ...
              const s = { l: 48, m: 49, q: 50, h: 51 };
              if ((void 0 === i && (i = 'm'), !(i in s)))
                throw new Error('Error level must be l, m, q or h');
              this._queue([29, 40, 107, 3, 0, 49, 69, s[i]]);
              let o = n.encode(e, 'iso88591'),
                c = o.length + 3;
              return (
                this._queue([29, 40, 107, c % 255, c / 255, 49, 80, 48, o]),
                this._queue([29, 40, 107, 3, 0, 49, 81, 48]),
                this
              );
            }
            image(e, t, r, n, i) {
              if (t % 8 != 0) throw new Error('Width must be a multiple of 8');
              if (r % 8 != 0) throw new Error('Height must be a multiple of 8');
              void 0 === n && (n = 'threshold'), void 0 === i && (i = 128);
              let c = a(t, r).getContext('2d');
              ...
              let h = (e, r) => (f.data[4 * (t * r + e)] > 0 ? 0 : 1),
                u = new Uint8Array((t * r) >> 3);
              for (let e = 0; e < r; e++)
                for (let r = 0; r < t; r += 8)
                  u[e * (t >> 3) + (r >> 3)] =
                    (h(r + 0, e) << 7) |
